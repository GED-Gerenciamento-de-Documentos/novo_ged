"""
Infrastructure — Acesso aos arquivos GED no servidor de arquivos.
...
class GedFileStorage:
    """
    Lê arquivos JBIG2/JPG do servidor de arquivos GED em modo síncrono.
    """

    def __init__(self):
        self._fallback_unc_host = getattr(settings, "GED_FILE_SERVER_HOST", "YOUR_FILE_SERVER_IP")
