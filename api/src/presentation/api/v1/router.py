...
from src.presentation.api.v1.documents.search_dev_router import router as search_dev_router
...
api_v1_router.include_router(search_dev_router)   # ← Busca sem auth (DEV only)
